		...
		<div class="register-box-body">
			...
			<?php echo form_open('Register/signup');?>
				<div class="form-group has-feedback">
					<input type="text" class="form-control" name="txtname" placeholder="Full name">
				</div>
				<div class="form-group has-feedback">
				...
				<div class="form-group has-feedback">
					<input type="password" class="form-control" name="txtretrypassword" placeholder="Retype password">
				</div>
				<div class="row">
					<!-- /.col -->
					<div class="col-xs-4">
